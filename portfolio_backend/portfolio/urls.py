...
urlpatterns = [
    ...
    path('paper-trades/manual/', PaperTradeManualCreateView.as_view()),
    ...
    path('active-signals/manual/', ActiveSignalManualCreateView.as_view()),
    path('active-signals/', ActiveSignalListView.as_view()),
    path('active-signals/close/', ActiveSignalCloseView.as_view()),
    ...
    path('ai/analysis/', GetAIAnalysisView.as_view()),
    path('scout/value-navigator/', ValueNavigatorAPI.as_view()),
    path('scout/value-navigator/recommendation/', ValueNavigatorRecommendation.as_view()),
