...
from .views import (
    ...
    PortfolioOptimizerEndpointView,
...
urlpatterns = [
    ...
    path('ai/consult/', AIConsultView.as_view()),
    path('ask-the-quant-stream/', AskTheQuantStreamView.as_view()),
    path('ai-center/', AICenterView.as_view()),
    path('ai/consensus/', DanasConsensusView.as_view()),
    ...
    path('optimizer/', PortfolioOptimizerEndpointView.as_view()),
    ...
    path('risk-snapshot/', RiskSnapshotView.as_view()),
