  ...
  return (
    <span className="relative inline-flex items-center normal-case font-normal">
      ...
      {open && (
        <span
          role="tooltip"
          className="absolute z-50 left-1/2 -translate-x-1/2 top-full mt-2 w-56 rounded-lg border border-slate-700 bg-slate-900 px-3 py-2 text-xs font-normal normal-case leading-snug text-slate-200 shadow-xl"
        >
          {text}
        </span>
      )}
